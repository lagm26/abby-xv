...
export default function QuinceInvitation() {
  ...
  // Fetch directo — el proxy /api/rsvp ya maneja CORS
          ...
          <div style={{ maxWidth: 620, margin: "0 auto" }}>
            ...
            <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
                ...
                <a href={`${GOOGLE_SCRIPT_URL}?action=get`} target="_blank" rel="noopener noreferrer"
                  style={{ background: "transparent", border: `1px solid rgba(201,168,76,.25)`, color: C.dim, padding: "8px 14px", cursor: "pointer", borderRadius: 6, fontFamily: "'Cinzel',serif", fontSize: 9, letterSpacing: ".12em", textDecoration: "none", display: "flex", alignItems: "center" }}>
                  🔗 PROBAR URL
                </a>
